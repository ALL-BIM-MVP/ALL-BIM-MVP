...
import routerIfcMetrados, { ifcFilesRouter } from './routes/metrados/ifc-metrados.routes.js';
import routerTemplates from './routes/metrados/templates.routes.js';
import routerModules, { projectModulesRouter } from './routes/modules.routes.js';
import routerIfcSpecialties, { projectIfcDocumentsRouter } from './routes/metrados/ifc-documents.routes.js';
import routerIfcClassification from './routes/metrados/ifc-classification.routes.js';
import routerElementoConjunto from './routes/metrados/elemento-conjunto.routes.js';
import { warehouseStyleRouter, model3DAssetUploadRouter, projectAlmacenRouter } from './routes/almacen/index.js';
import { errorHandler } from './middlewares/error.middleware.js';
import { recoverStaleProcessingRows } from './services/metrados/ifc-processing-runner.js';
