...
import { Ruler, HardHat, ClipboardList, Package, FileSpreadsheet, Layers, Warehouse } from 'lucide-react';
...
export const MODULOS = [
  ...
  { id: 'almacen', icon: Warehouse, label: 'ALMACÉN BIM', color: 'bg-teal-50 text-teal-700 border-teal-200' }
];